...
struct pwVerificationView: View {
...
struct pwVerificationView_Previews: PreviewProvider {
        @State static private var showNextView: DisplayState = .verification

        static var previews: some View {
            pwVerificationView(showNextView: $showNextView)
        }
