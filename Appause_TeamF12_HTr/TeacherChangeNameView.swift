...
struct TeacherChangeNameView: View {
    ...
    var body: some View {
        VStack (alignment: .leading) {
            ...
            VStack (alignment: .leading){
                ...
                TextField("First Name", text: $firstName) // Text field for entering new first name
                    .font(.system(size: 20))
                    .padding()
                    .frame(width: 350, height: 50) // Make the text field bigger
                    .textFieldStyle(CustomTextFieldStyle()) // Apply custom text field style
                //Spacer()
                Text("Last Name:")
                    .foregroundColor(.black)
                    .font(.system(size: 24))
                ...
                TextField("Last Name", text: $lastName) // Text field for entering new last name
                    .font(.system(size: 20))
                    .padding()
                    .frame(width: 350, height: 50) // Make the text field bigger
                    .textFieldStyle(CustomTextFieldStyle()) // Apply custom text field style
                ...
                {
                    TextFieldWithEyeIcon(placeholder: "Password", text: $password, isSecure: false, visibility: $passwordStatus)
                }
                else
                {
...
struct TeacherChangeNameView_Previews: PreviewProvider {
    @State static private var showNextView: DisplayState = .teacherChangeNameView
    static var previews: some View {
        TeacherChangeNameView(showNextView: $showNextView)
    }
}
