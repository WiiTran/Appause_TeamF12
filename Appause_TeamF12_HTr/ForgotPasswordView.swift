...
struct ForgotPasswordView: View {
    ...
    @State private var viewNext: DisplayState = .verification
    ...
    var body: some View {
        VStack {
            ...
            Text("Please enter the email associated with your account. A temporary code wil be sent to reset your password.")
